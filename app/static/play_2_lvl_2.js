...
function preload() {
    this.load.image('anim0', '/static/img/schz/anim0.png');
    this.load.image('anim1', '/static/img/schz/anim1.png');
    this.load.image('anim2', '/static/img/schz/anim2.png');
    this.load.image("background", '/static/img/schz/fon.png')
    this.load.image("don_none", '/static/img/schz/don_none.png');
    this.load.image("don_full", '/static/img/schz/don_full.png');
}
...
function create() {
    ...
    img_don_none = this.add.image(250 * coeff, 150 * coeff, 'don_none').setScale(0.167 * coeff).setInteractive();
